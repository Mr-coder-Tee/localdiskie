...
import {View ,Textm,FlatList} from 'react-native'
import { Postcard,LogIn } from '../index'
...
const Home = ({props,bottomSheet,bottomSheetComment}) => {
    ...
    return ( <View style={{padding:10}}>
        ...
        renderItem={({ item, index }) => {
            return <Postcard navigation={navigation} data={item} bottomSheet={bottomSheet} bottomSheetComment={bottomSheetComment}/>
          }}
        />
    </View> );
}
